...
> Project/src/main/java/my.spring.springweb.sample01/TestController01.java
...
> Project/src/main/webapp/WEB-INF/views/sample01/testController01.jsp
...
> http://localhost:8080/springweb/testController01 접속 시

<img src="스크린샷 2023-02-24 오후 1.46.51.png" />

### sample01/TestController02.java
> Project/src/main/java/my.spring.springweb.sample01/TestController02.java
...
### sample01/TestController03.java
> Project/src/main/java/my.spring.springweb.sample01/TestController03.java

### sample01/TestController04.java
> Project/src/main/java/my.spring.springweb.sample01/TestController04.java

### sample01/TestController05.java
> Project/src/main/java/my.spring.springweb.sample01/TestController05.java

## InternalResourceView Class

### sample01/TestController06.java

## Model, ModelAndView class

### sample01/TestController07.java

## EL

JSP 2.0 spec 안에 포함돼 있습니다. <code>EL</code>은 JSP의 <code><%= %> (JSP Expression)</code>이나 <code><% %>(JSTL, JSP Scriptlet)</code> 대신 사용합니다.
...
pageScope > requestScope > seesionScope > applicationScope 순으로 스코프란 공간을 돌며 모델 객체를 찾아서 값을 찍습니다.
...
5. param
  - 클라이언트 리퀘스트 파라미터의 이름과 값을 가지고 있는 내장 객체
6. header
  - 클라이언트 리퀘스트 헤더 정보
7. cookie